...
TFSExpected<rppsync::TSharedRw<TFileObject>> TFileSystem::Find(const TStdPath& path) {
    return DoFind(path, path.begin(), s_pRootDir);
}

TFSExpected<rppsync::TSharedRw<TFileObject>> TFileSystem::DoFind(const TStdPath& path,
...
TFSExpected<rppsync::TSharedRw<TFileObject>> TFileSystem::ContinueFind(const TStdPath& path,
    TStdPathIt it, const rppsync::TSharedRw<TFileObject>& obj) {
